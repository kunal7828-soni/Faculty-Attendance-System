...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  void _changeAttendanceMode(AttendanceStatus newMode) {
    ...
    final hasChanges =
        students.any((s) => s.status != _currentMode);
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pop(
                  context,
                ); // Close drawer after applying mode.
              },
          ...
          children: [
            ...
            Card(
              ...
              child: ListTile(
                ...
                subtitle: const Text(
                  'Add, edit or remove students from the master list',
                ),
                trailing:
